...
{
    public partial class ChamJointForm : MetroFramework.Forms.MetroForm
    {
        public ChamJoint chamJoint;
        private BindingSource existsSource;
        public DialogResult result = DialogResult.Cancel;
        public ChamJointForm()
        {
            InitializeComponent();
            catalogListBox1.SetDataSource(MainTrackStructureService.GetCatalog(MainTrackStructureConst.MtoChamJoint));
        }
        public void SetChamJointForm(ChamJoint obj)
        {
