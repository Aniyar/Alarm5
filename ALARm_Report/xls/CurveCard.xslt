...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt"
	...
	<xsl:template match="/">
		<html>
			...
			<head>
				<title>
					Карточка кривой на не скоростных линиях (ФП-3.2)
				</title>
				...
				<xsl:for-each select="report/curve">
					<xsl:choose>
						<xsl:when test="@ismulti">
							<div align="center" style="page-break-before:always; margin:20px 0px 0px">
						...
						<xsl:otherwise>
							...
							<div align="center" style="margin:20px 0px 0px">
					...
					<div align="center">
						<table class="main">
                            ...
                            <td align="center" class="main">Ψ</td> -->
								...
								<td colspan="2" align="center" class="main">Пасс</td>
								<td colspan="2" align="center" class="main">Груз</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td rowspan="2" colspan="3" align="center" class="main">
									&gt;6мм =
								...
								<td rowspan="2" colspan="2" align="center" class="main">
									&gt;15мм =
							...
							<tr>
								...
								<td colspan="2" align="center" class="main">
									<xsl:value-of select="speed/@AgPassMax" />
								</td>
								<td colspan="2" align="center" class="main">
									<xsl:value-of select="speed/@AgFreigMax" />
								</td>
							</tr>
							<tr>
								<td colspan="4" align="center" class="main">
								...
								<td colspan="2" align="center" class="main">
									<xsl:value-of select="speed/@FiPassMax" />
								</td>
								<td colspan="2" align="center" class="main">
									<xsl:value-of select="speed/@FiFreigMax" />
								</td>
							</tr>
							<xsl:if test="@ismulti">
								<tr>
					...
					<div class="curve_chart">
						...
						<div style="top: -104px; left: 10px; position: relative; text-align: left; font-size: 9px; font-family: Arial;">Аг пасс.</div>
						<div style="top: -93px; left: 10px; position: relative; text-align: left; font-size: 9px; font-family: Arial;">Аг груз.</div>
						<div style="top: -141.364px;left: -32px;position:relative;width: 676px;text-align: right;">0.9</div>
						<div style="top: -140.364px;left: -32px;position:relative;width: 676px;text-align: right;">0.7</div>
						<div style="top: -112.18px;left: -32px;position:relative;width: 676px;text-align: right;">0.3</div>
						<div style="top: -95.18px;left: -32px;position:relative;width: 676px;text-align: right;">0.0</div>
					</div>
					...
					<div style="width: 620px; top: 0; right: 0; bottom: 0; left: 0; margin: auto; height: 23px;">
						<svg preserveAspectRatio="none" vector-effect="non-scaling-stroke" viewBox="-10 0 968 32" style="border: 1px solid;height: 22px;width: 620px; BACKGROUND: yellow;">
							<xsl:for-each select="Speeds/Speed">
								<text x="500" y="23" style="font: 20px sans-serif;">
