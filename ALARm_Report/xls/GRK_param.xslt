...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		<html>
			<head>
				<title>Ведомость ССКО параметров ГРК по километрам </title>
				<style>
					td {
					padding-left: 5px;
					}
			...
			<body>
				...
				<xsl:for-each select="report/trip">
					...
					<div   id="pageFooter" style="text-align: right;page-break-before:always; margin:50px 0px 0px">
						...
						<H4 align = "center">Ведомость ССКО параметров ГРК по километрам</H4>
						...
						<table class="main">
							<thead>
								<tr>
									...
									<td align="center" colspan="1" class="main">Перекос</td>
									<td align="center" colspan="1" class="main">Уровень</td>
									<td align="center" colspan="1" class="main">Прос.пр </td>
									<td align="center" colspan="1" class="main">Прос.лв </td>
									<td align="center" colspan="1" class="main">
										С<sub>0</sub>
									</td>
									<td align="center" colspan="1" class="main">Шаблон</td>
									<td align="center" colspan="1" class="main">Рихт.пр </td>
									<td align="center" colspan="1" class="main">Рихт.лв </td>
								</tr>
								<tr>
									<td colspan="7">
							...
							<tbody>
								<xsl:for-each select="note">
									<tr class="tr">
										...
										<td class="main" align="center" >
											<xsl:value-of select="@Pros.pr"/>
										</td>
										<td class="main" align="center" >
											<xsl:value-of select="@Pros.lv"/>
										</td>
										<td class="main" align="center" >
										...
										<td class="main" align="center" >
											<xsl:value-of select="@Riht.pr"/>
										</td>
										<td class="main" align="center" >
											<xsl:value-of select="@Riht.lv"/>
										</td>
									</tr>
								</xsl:for-each>
