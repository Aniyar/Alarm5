						...
						<div class = "main-chart">
							<svg class= "chart">
                                ...
                                <text x="765" style="font-size: 12;" text-anchor="end">
                                    <xsl:attribute name="y"><xsl:value-of select="@topx1" /></xsl:attribute>
                                    <xsl:value-of select="@top-title"/> 
                                </text>
                                <text x="765" style="font-size: 12;" text-anchor="end"> 
                                    <xsl:attribute name="y"><xsl:value-of select="@topx2" /></xsl:attribute>
                                    <xsl:value-of select="@speedlimit"/> 
                                </text>
                                <rect fill="none" stroke="black" x="217" width="550" height="35">
                                    <xsl:attribute name="y"><xsl:value-of select="@topr" /></xsl:attribute>
                                </rect>


                                <text transform="rotate(90)" font-size="11" y="-770">
                                    <xsl:attribute name="x"><xsl:value-of select="@topx" /></xsl:attribute>
                                    <xsl:value-of select="@right-title"/> 
                                </text>
                                
                                <text fill="black" x="0" font-size="10">
                                    <xsl:attribute name="y"><xsl:value-of select="@topf" /></xsl:attribute>
...
<!-- 
                                ...
                                <xsl:for-each select="xgrid/L">
                                    ...
                                    <text x="1" style="transform: rotate(90deg);font-size: 7;text-align: right; white-space:pre" y="-{.-2}">0</text>
                                </xsl:for-each>
                            ...
                            <xsl:for-each select = "digressions/R">
                                ...
                                <text x="0" font-size="8" y="31.5">
                                    ...
                                    <tspan x="95">|Дл.</tspan>
                                    <tspan x="110">|Кол</tspan>
                                    <tspan x="125">|Балл</tspan>
                                    <tspan x="143">| Огр.ск.</tspan>
                                    <tspan x="175">|</tspan>
                                    <tspan x="200">Неров. проф.</tspan>
                                    <tspan x="260">|</tspan>
                                    <tspan x="285">Зазор.лв.</tspan>
                                    <tspan x="335">|</tspan>
                                    <tspan x="360">Зазор пр.</tspan>
                                    <tspan x="410">|</tspan>
                                    <tspan x="440">Износ</tspan>
                                    <tspan x="490">|</tspan>
                                    <tspan x="525">Отжатие</tspan>
                                    <tspan x="580">|</tspan><tspan x="610">Шаблон</tspan><tspan x="665">|</tspan>
                                    <tspan x="685">План</tspan><tspan x="730">| Км</tspan>
                                </text>

                                <rect x="0" height="12" width="770" style="fill: none;stroke: black;">
                                    <xsl:attribute name="y"><xsl:value-of select="@prer"/></xsl:attribute>
                                </rect>
							</svg>
						</div>
