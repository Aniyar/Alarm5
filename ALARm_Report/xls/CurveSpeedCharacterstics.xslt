...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		<html>
			<head>
				<title>
					Ведомость характеристик устройства кривых <br/> скоростных и высокоскоростных участков пути
				</title>
				<style>
					table.main {
			...
			<body>
				<div style="page-break-before:always;">
					...
					<table style="font-size: 15px; font-family: 'Times New Roman';width: 100%; margin: auto;margin-bottom:8px;border-collapse: collapse">
						<td align = "center">
							<b>
								Ведомость характеристик устройства кривых <br/> скоростных и высокоскоростных участков пути
							</b>
							...
							<tbody>
								<xsl:for-each select="report/curve">
									<tr>
										...
										<td align="center" class="main">Сапс.</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@AnpAvg"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@AgMax"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Psi"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Vpz"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Vkr"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Vpr"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Viz"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Vdp"/>
										</td>
									</tr>
									<tr>
										<td align="center" style="border-top:0;border-bottom:0;" class="main">
										...
										<td align="center" class="main">Ласт. </td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@AnpAvg2"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@AgMax2"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Psi2"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Vpz2"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Vkr2"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Vpr2"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Viz2"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Vdp2"/>
										</td>
									</tr>
									<tr>
										...
										<td align="center" class="main">Стриж. </td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@AnpAvg3"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@AgMax3"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Psi3"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Vpz3"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Vkr3"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Vpr3"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Viz3"/>
										</td>
										<td align="center" class="main">
											<xsl:value-of select="speed/@Vdp3"/>
										</td>
									</tr>
								</xsl:for-each>
							</tbody>
