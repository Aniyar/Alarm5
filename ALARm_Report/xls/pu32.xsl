          ...
          <table style="font-size: 15px; font-family: 'Times New Roman';width: 100%; margin: auto;margin-bottom:8px;border-collapse: collapse;height:8%;padding: 5px">
            <xsl:choose>
              ...
              <xsl:otherwise>
                ...
                <tr>
                  <td style="height:3%;margin:auto; padding: 20px;margin-bottom:8px;">
                    Дата проверки: <xsl:value-of select="@from" />-<xsl:value-of select="@to" />
                  </td>
                </tr>
              </xsl:otherwise>
            </xsl:choose>
					  ...
					  <xsl:if test="../../@reptype='Comparative'">
						  ...
						  <xsl:for-each select="section">
							  <tr>
								  ...
								  <td>
									  <xsl:value-of select="@cexcellent" />
								  </td>
								  <td>
									  <xsl:value-of select="@cgood" />
								  </td>
								  <td>
									  <xsl:value-of select="@csatisfactory" />
								  </td>
								  <td>
									  <xsl:value-of select="@cbad" />
								  </td>
								  <td>
									  <xsl:value-of select="@climit" />
								  </td>
								  <td>
									  <xsl:value-of select="@cd4" />
								  </td>
								  <td>
									  <xsl:value-of select="@cother" />
								  </td>
								  <td>
									  <xsl:value-of select="@cadd" />
								  </td>
								  <td>
									  <xsl:value-of select="@crepair" />
								  </td>
								  <td>
									  <xsl:value-of select="@cmainavg" />
								  </td>
								  <td>
									  <xsl:value-of select="@caddavg" />
								  </td>
								  <td>
									  <xsl:value-of select="@cns" />
								  </td>
								  <td>
									  <xsl:value-of select="@crating" />
								  </td>
								  <xsl:if test="../../../@reptype='Comparative'">
									  <xsl:if test="position()=1">
										  <td style="word-wrap: break-word">
			   ...
			   <xsl:for-each select="bykilometer">
                  ...
                  <xsl:for-each select="countbytype">
                    <tr>
                      ...
                      <td>
                        <xsl:value-of select="@cconst" />
                      </td>
                      <td>
                        <xsl:value-of select="@cbroad" />
                      </td>
                      <td>
                        <xsl:value-of select="@clevel" />
                      </td>
                      <td>
                        <xsl:value-of select="@csag" />
                      </td>
                      <td>
                        <xsl:value-of select="@cdown" />
                      </td>
                      <td>
                        <xsl:value-of select="@cstright" />
                      </td>
                      <td>
                        <xsl:value-of select="@ccombination" />
                      </td>
                      <td>
                        <xsl:value-of select="@cother" />
                      </td>
                      <td>
                        <xsl:value-of select="@ccurves" />
                      </td>
                      <td>
                        <xsl:value-of select="@cadditional" />
                      </td>
                      <td>
                        <xsl:value-of select="@csum" />
                      </td>
                    </tr>
                  </xsl:for-each>
                </xsl:for-each>
                      ...
                      <xsl:for-each select="pchu">
						   ...
						   <xsl:if test="../../../../../../@reptype='Comparative'">
							...
							<tr>
                              <td style="text-align:left">
                                ...
                                <xsl:value-of select="@cratecount" />
                              </td>
                            </tr>	  
						    </xsl:if>
                          </xsl:for-each>
						...
						<tr>
                            <td colspan="2" rowspan="2" style="text-align:left">
                              ПД <xsl:value-of select="@code" />
                              <br />
                              Итого-<xsl:value-of select="@clen" />
                            </td>
                            <td>
                              <xsl:value-of select="@cc1" />
                            </td>
          ...
          <xsl:if test="@reptype!='Comparative'">
            <div style="page-break-before:always;">
              ...
              <table width="100%" border="1" cellpadding="0" cellspacing="0" class="demotable" align="center">
                ...
                <xsl:for-each select="trip[1]/bykilometer/section/pchu/pd">
                  <tr>
                    <td>
                      <xsl:value-of select="@code" />
                      &#160;&#160;&#160;
