...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		<html>
			<head>
				<title>Ведомость участков со сверхнормативным боковым износом рельсов </title>
				<style>
					td {
					padding-left: 5px;
					}
			...
			<body>
				...
				<xsl:for-each select="report/trip">
					...
					<div   style="page-break-before:always; margin:50px 0px 0px">
						...
						<H4 align = "center">Ведомость участков со сверхнормативным боковым износом рельсов</H4>
						...
						<table class="main">
							<thead>
								<tr>
									...
									<td align="center" colspan="1" class="main">Отступление</td>
