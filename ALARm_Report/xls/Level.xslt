						...
						<div class="addparam">
							...
							<div class="main-chart">
								<svg preserveAspectRatio="none" vector-effect="non-scaling-stroke" class="chart">
									...
									<text fill="black" x="0" font-size="7" style="transform: scaleX(2);">
										<xsl:attribute name="y">
									...
									<text fill="dimgray" text-anchor="end" font-size="5.5" y="-203.5" x="10" style="transform: rotate(90deg) scaleY(2);">  –30</text>
									<text fill="dimgray" text-anchor="end" font-size="5.5" y="-233" x="10" style="transform: rotate(90deg) scaleY(2);">      0</text>
									<text fill="dimgray" text-anchor="end" font-size="5.5" y="-263" x="10" style="transform: rotate(90deg) scaleY(2);">    30</text>
									...
									<xsl:for-each select="digressions/m">
										<xsl:if test="../../@Page = 0 and @Meter &gt;= 520">
											<text fill="dimgray" font-size="5px" style="white-space: pre; transform: scaleX(2);" >
												<xsl:attribute name="y">
													<xsl:value-of select="@top" />
												</xsl:attribute>
												<xsl:attribute name="x">
													<xsl:value-of select="@x*0.5" />
												</xsl:attribute>
										...
										<xsl:if test="../../@Page = 1 and @Meter &lt; 520">
											<text fill="dimgray" font-size="5px" style="white-space: pre; transform: scaleX(2);" >
												<xsl:attribute name="y">
													<xsl:value-of select="@top" />
												</xsl:attribute>
									...
									<xsl:for-each select="digressions/rect">
										<rect width="140" height="10" style="stroke-width:0.5;fill:none;stroke: darkgray;">
											<xsl:attribute name="y">
												<xsl:value-of select="@top" />
											</xsl:attribute>
											<xsl:attribute name="x">
									...
									<text x="-50" font-size="5" y="20" style="transform: scaleX(2);">
										<tspan x="1">м</tspan>
										<tspan x="10.">|Отст </tspan>
										<tspan x="28"> |Ст  </tspan>|Откл   |  Дл.   | Кол | Огр.ск
										<tspan x="185"></tspan>
										<tspan x="227">Уровень</tspan>
										<tspan x="365">| Км</tspan>
									</text>

									<rect x="-20" height="10" width="786" style="fill: none;stroke: black;">
										<xsl:attribute name="y">
											<xsl:value-of select="@prer" />
										</xsl:attribute>
									</rect>

									<!-- <rect x="-20" height="10" width="786" style="fill: none;stroke: black;" y="13"></rect> -->
								</svg>
