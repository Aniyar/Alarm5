...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/">
    <html>
      <head>
        <title>Ведомость сверхнормативных длинных профильных неровностей</title>
        <style>
          td {
          padding-left: 5px;
          }
      ...
      <body>
        ...
        <xsl:for-each select="report/trip">
          <div   style="page-break-before:always; margin:50px 0px 0px">
            ...
            <H4 align = "center">Ведомость сверхнормативных длинных профильных неровностей</H4>
          </div>
          <div align="center">
          ...
          <div align="center">
            ...
            <table class="main">
              <thead>
                <tr>
                  <td align="center" colspan="1" rowspan="1" class="main">Км</td>
                  <td align="center" colspan="1" rowspan="1" class="main">м</td>
                  <td align="center" colspan="1" rowspan="1" class="main">Амплитуда, мм  </td>
                  <td align="center" colspan="1" rowspan="1" class="main">Длина, м</td>
                  <td align="center" colspan="1" rowspan="1" class="main">Vпз</td>
                  <td align="center" colspan="1" rowspan="1" class="main">Примечание</td>
                </tr>
                <tr>
