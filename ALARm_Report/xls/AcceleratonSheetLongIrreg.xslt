...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" version="1.0" exclude-result-prefixes="msxsl">
  <xsl:template match="/">
    <html>
      <head>
        <title>Ведомость ускорений, вызванных длинными неровностями (на скоростных линиях) </title>
        <style>
          td {
          padding-left: 5px;
          }
      ...
      <body>
        ...
        <xsl:for-each select="report/trip">
          <div   style="page-break-before:always; margin:50px 0px 0px">
            ...
            <H4 align = "center">
              Ведомость ускорений, вызванных длинными неровностями <br/>(на скоростных линиях)
            </H4>
          </div>
          <div align="center">
          ...
          <div align="center">
            ...
            <table class="main">
              <thead>
                <tr>
                  <td align="center"  colspan="6"  class="main">
                ...
                <tr>
                  <td align="center" colspan="1" rowspan="2" class="main">Км</td>
                  <td align="center" colspan="1" rowspan="2" class="main">м</td>
                  <td align="center" colspan="1" rowspan="2" class="main">Vпз, км/ч </td>
                  <td align="center" colspan="1" rowspan="2" class="main">Макс. неровность, <br/>мм</td>
                  <td align="center" colspan="3" rowspan="1" class="main">Дополнительное ускорение </td>
                  <td align="center" colspan="1" rowspan="2" class="main">Баллы </td>
                  <td align="center" colspan="1" rowspan="2" class="main">Примечание</td>
                </tr>
                <tr>
                  <td align="center" colspan="1" rowspan="2" class="main">Длина участка, м</td>
                  <td align="center" colspan="1" rowspan="2" class="main">
                    В плане, м/с<sup>2</sup>
                  </td>
                  <td align="center" colspan="1" rowspan="2" class="main">
                    В профиле, м/с<sup>2</sup>
                  </td>
                </tr>
              ...
              <tbody>
                <xsl:for-each select="directions/tracks/main">
                  <tr class="tr">
                    ...
                    <td class="main" align="center">
                      <xsl:value-of select="@nerov"/>
                    </td>
                    <td class="main" align="center">
                      <xsl:value-of select="@len"/>
                    </td>
                    <td class="main" align="center">
                      <xsl:value-of select="@vplane"/>
                    </td>
                    <td class="main" align="center">
                      <xsl:value-of select="@vprofile"/>
                    </td>
                    <td class="main" align="center" >
