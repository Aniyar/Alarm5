...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" version="1.0" exclude-result-prefixes="msxsl">
  ...
  <xsl:template match="/">
    <html>
      <head>
        <title>ВЕДОМОСТЬ ОТСТУПЛЕНИЙ В СОДЕРЖАНИИ РЕЛЬСОВ</title>
        <style>
          .pages {
          ...
          <div class="pages" align="center">
            <table style="font-size: 12px; font-family: 'Times New Roman'; width: 100%; margin: auto;">
              <tr>
                <td>
                  <b>
                    <p align="left" style="color:black; font-size:14px">ВЕДОМОСТЬ ОТСТУПЛЕНИЙ В СОДЕРЖАНИИ РЕЛЬСОВ</p>
                  </b>
                </td>
              </tr>
            ...
            <table class="main">
              <thead>
                <tr>
                  ...
                  <td class="main" align="center">Величина, мм</td>
