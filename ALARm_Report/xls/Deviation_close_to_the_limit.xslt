			...
			<body>
				...
				<xsl:for-each select="report/trip">
					...
					<div id="pageFooter"  align="right"   style="page-break-before:always; margin:50px 0px 0px">
						...
						<H4 align = "center">	Отступление,близкие к предельным  </H4>
					...
					<div align="center">
						...
						<table class="main">
							<thead>
								...
								<tr>
									<td align="center" colspan="9" class="main">По основным параметрам</td>
								</tr>
								<tr>
									...
									<td align="center" colspan="1" class="main">Откл,мм </td>
							...
							<tbody>
								...
								<tr>
									<td align="center" colspan="8" class="main">По дополнительным параметрам </td>
								</tr>
								<tr>
									<td align="center" colspan="1" class="main">Км</td>
									<td align="center" colspan="1" class="main">м</td>
								...
								<xsl:for-each select="directions/tracks">
									<tr>
										<th align="left" colspan="7" class="main">
									...
									<tr>
										<th align="left" colspan="7"  class="main">Итого по ПЧ                     </th>
										<th align="center" colspan="1" class="main">
