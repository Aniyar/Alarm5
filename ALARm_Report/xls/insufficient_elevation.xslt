...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		<html>
			<head>
				<title>Ведомость кривых с недостаточным возвышением </title>
				<style>
					td {
					padding-left: 5px;
					}
			...
			<body>
				...
				<xsl:for-each select="report">
					...
					<div id="pageFooter" style="text-align: right;page-break-before:always; margin:50px 0px 0px">
						...
						<H4 align = "center">Ведомость кривых с недостаточным возвышением</H4>
					...
					<div align="center">
						<table style="font-size: 12px; font-family: 'Times New Roman'; width: 100%; margin: auto;margin-bottom:8px;border-collapse: collapse">
							<tr>
								...
								<td align="left">
									Дорога: <xsl:value-of select="curve/@road" />
								</td>
							...
							<tr>
								...
								<td align="left">
									Проверка:<xsl:value-of select="curve/@type" /> &#160;&#160;&#160;&#160;&#160;&#160; <xsl:value-of select="curve/@period" />
								</td>
							</tr>
						</table>
					</div>
							...
							<thead>
								<tr>
									...
									<td align="center" colspan="1" rowspan="2" class="main">
										Начало кривой,<br/>км.м
									</td>
									<td align="center" colspan="1" rowspan="2" class="main">
										Конец кривой,<br/> км.м
									</td>
									<td align="center" colspan="1" rowspan="2" class="main">
										Радиус,<br/>м
									</td>
								...
								<tr>
									<td colspan="6"  class="main">
										Направление:   <xsl:value-of select="curve/@direction"/>
									</td>
							...
							<tbody>
								<xsl:for-each select="curve/param_curve">
									<tr class="tr">
										...
										<td class="main" align="center">
											<xsl:value-of select="@final_km"/>.<xsl:value-of select="@final_km"/>
										</td>
										<td class="main" align="center">
					...
					<table style="font-size: 12px; width: 100%;height: 5%; margin: auto;">
						<tr>
							<td align="left">
								Начальник &#160;&#160;<xsl:value-of select="curve/@PC" />
							</td>
