...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" version="1.0" exclude-result-prefixes="msxsl">
	...
	<xsl:template match="/">
		<html>
			<head>
				<title>Эпюра шпал в стыку</title>
				<style>
					.pages {
					...
					<div class="pages" align="center">
						...
						<table style="font-size: 14px; font-family: Times New Roman; width: 100%; margin: auto;">
							<tr>
								<td>
									<b>
										<p align="left" style="color:black; font-size:14px">Эпюра шпал в стыку</p>
									</b>
								</td>
							</tr>
							<tr>
						...
						<table class="main">
							<thead>
								<tr>
									...
									<td class="main" valign = "top" align="center">ПЧУ, ПД, ПДБ</td>
									...
									<td class="main" align="center">Заход стыка на шпалу, мм</td>
									<td class="main" align="center">Междушпальное расстояние, мм</td>
								...
								<xsl:for-each select="tracks">
									...
									<xsl:for-each select="elements">
										<tr>
											...
											<td class="main" align="center">
												<xsl:value-of select="@joint" />
											</td>
											<td class="main" align="center">
												<xsl:value-of select="@joint1" />
											</td>
											<td class="main" align="center">
