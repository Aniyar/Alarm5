...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" version="1.0" exclude-result-prefixes="msxsl">
	...
	<xsl:template match="/">
		<html>
			<head>
				<title>ГД основных парамеров ГРК на участвке скоросного движения</title>
				<style>
					.addparam {
						...
						<div class = "main-chart">
							<svg class= "chart">
								...
								<text x="0" font-size="10">
									...
									<tspan x="55"> |Ст</tspan>|Откл|Дл.| Балл|  Огр.ск
									<tspan x="185">|</tspan>
									<tspan x="235">Уровень</tspan>
									<tspan x="320">|</tspan>
									<tspan x="340">Рихтовка л.</tspan>
									<tspan x="412">|</tspan>
									<tspan x="435">Рихтовка пр.</tspan>
									<tspan x="508">|</tspan>
									<tspan x="545">Шаблон</tspan>
									<tspan x="618">|</tspan>
									<tspan x="630">Пр. л. </tspan>
									<tspan x="675">|</tspan>
									<tspan x="688">Пр. пр. </tspan>
