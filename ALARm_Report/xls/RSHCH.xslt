				...
				<xsl:for-each select="report/trip">
					...
					<div align="center">
						<table style="font-size: 12px; font-family: 'Times New Roman'; width: 100%; margin: auto;margin-bottom:8px;border-collapse: collapse">
							...
							<tr>
								...
								<td align="left">
									Пороговое значение РШК - <xsl:value-of select="@periodDate" />
								</td>
					...
					<div align="center">
						...
						<table class="main">
							<thead>
								<tr>
									<td align="center" colspan="2" class="main">Начало отжатия</td>
									<td align="center" colspan="1" rowspan="2" class="main">Длина отжатия, м</td>
									<td align="center" colspan="1" rowspan="2"  class="main">Макс. РШК,мм</td>
									<td align="center" colspan="1" rowspan="2"  class="main">Радиус,м</td>
									<td align="center" colspan="1" rowspan="2"  class="main"> &#160;&#160;&#160;Vпз</td>
									<td align="center" colspan="1" rowspan="2"  class="main">Промежуточное скрепление</td>
								</tr>
								<tr>
									<th class="main">Км</th>
									<th class="main">М</th>
